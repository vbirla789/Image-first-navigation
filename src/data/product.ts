...
export interface Review {
  ...
  body: string
  fullBody: string
  /** "Bought:" variant chips shown in the expanded image-first review */
  boughtChips?: string[]
  chips: string[]
  variantInfo: string
  photos: ReviewPhoto[]
...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    variantInfo: 'Bought 42 mm, Silver, Manual',
    photos: [
      { id: 'r3p1', src: '/assets/watch-wrist-tag.png' },
      { id: 'r3p2', src: '/assets/watch-box-blue.png' },
    ],
    helpfulCount: 9,
    helpfulSelected: false,
  },
  {
    ...
    variantInfo: 'Bought 42 mm, Silver, Manual',
    photos: [
      { id: 'r4p1', src: '/assets/watch-box-hand.png' },
      { id: 'r4p2', src: '/assets/watch-couch.png' },
      { id: 'r4p3', src: '/assets/watch-wrist-dxb.png' },
    ],
    helpfulCount: 6,
    helpfulSelected: false,
  },
